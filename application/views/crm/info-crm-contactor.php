...
?>
<div class="info-crm row hidden" id="info-crm-contactor">
    <?php
    if ($this->canEdit):
    ?>
    <div class="col-lg-12 list-title-op">
        <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="lightbox({size:'m',url:'<?=site_url("crm/createContractor/".$this->id)?>'})"><span class="glyphicon glyphicon-file"></span> 新建</a>
    ...
    <div class="col-lg-12">
        ...
        <?php
        if (count($this->contactorList->record_list)==0):
        ?>
